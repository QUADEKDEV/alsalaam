...
const LeafletMap = () => {
  ...
  const initMap = () => {
    ...
    const hotelCoords = [7.403639, 3.943685];
    ...
    window.L.marker(hotelCoords, { icon: customIcon })
      ...
      .bindPopup(
        ...
        <div style="font-family: serif; text-align: center; padding: 5px;">
          <b style="font-size: 16px; color: #0f172a;">AL-SALAAM</b><br>
          <span style="color: #d97706; font-size: 14px;">★★★★★</span><br>
          <span style="color: #64748b; font-size: 12px;">Ibadan, Oyo State</span>
        </div>
      `,
      )
      .openPopup();
    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          value={form.email}
          onChange={handleChange}
          placeholder="example@alsalaam.com"
          required
          className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          onChange={handleChange}
          rows={4}
          placeholder="How can we make your next project exceptional?"
          required
        ...
        <div className="container mx-auto max-w-6xl text-center">
          ...
          >
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto font-light">
              We are a professional land surveying firm providing accurate,
              reliable, and innovative surveying solutions.
            </p>
          </motion.div>
        </div>
      </div>
