  ...
  return (
    <div className="relative min-h-screen bg-slate-900 flex items-center justify-center overflow-hidden font-sans selection:bg-amber-500 selection:text-white">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1628158145409-9e222b56cc0b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bGFuZCUyMHN1cnZleWluZ3xlbnwwfHwwfHx8MA%3D%3D"
          alt="Luxury Abstract"
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          <span className="text-xl font-serif font-bold text-white tracking-widest">
            AL-SALAAM GEO-MAPPING<span className="text-amber-500">.</span>
          </span>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-slate-400 text-lg mb-10 leading-relaxed">
              The page you are looking for is currently unoccupied... or perhaps
              it never existed. Let us guide you back to the comfort of our
              office.
            </p>
        ...
        >
          ...
          >
            <Search size={14} /> Search Product
          </a>
          <a
            href="#"
            className="hover:text-amber-400 transition-colors flex items-center gap-2"
          >
            <Map size={14} /> Office Map
          </a>
          <a
            href="#"
            className="hover:text-amber-400 transition-colors flex items-center gap-2"
          >
            <Home size={14} /> Our Services
          </a>
        </motion.div>
      </div>
    </div>
